									...
									<div className="mobile-contact-info mt-5 p-4 bg-light rounded-3">
										...
										<div className="contact-item mb-3 d-flex align-items-start">
											...
											<div>
												...
												<Link href="tel:+201099053978" className="text-dark text-decoration-none">
													+20 109 905 3978
												</Link>
											</div>
										</div>
										...
										<div className="contact-item mb-3 d-flex align-items-start">
											...
											<div>
												...
												<Link href="mailto:ahmedfouad01099@gmail.com" className="text-dark text-decoration-none">
										...
										<div className="contact-item mb-3 d-flex align-items-start">
											...
											<div>
												...
												<Link href="https://github.com/ahmedfouad01099" target="_blank" className="text-dark text-decoration-none">
													@ahmedfouad01099
												</Link>
											</div>
										</div>
										...
										<div className="contact-item mb-3 d-flex align-items-start">
											...
											<div>
												...
												<Link href="https://maps.google.com/maps?q=Cairo,Egypt" target="_blank" className="text-dark text-decoration-none">
													Cairo, Egypt
												</Link>
											</div>
										</div>
										...
										<div className="social-links mt-4 pt-3 border-top">
											...
											<div className="d-flex gap-3">
												<Link href="https://github.com/ahmedfouad01099" target="_blank" className="social-link btn btn-outline-dark btn-sm">
													<i className="ri-github-fill"></i> GitHub
												</Link>
												<Link href="https://www.linkedin.com/in/ahmed-fouad-b4b9b51a6/" className="social-link btn btn-outline-primary btn-sm">
