...
export default function Service2() {
  const services: ServiceItem[] = [
    ...
    },
    {
      ...
      description:
        "Improving the speed and performance of web applications to provide a better user experience. Work with <span class='text-secondary-2'>Nodejs</span>, <span class='text-secondary-2'>Express</span>",
    },
    {
      id: 5,
      icon: (
      ...
      description:
        "Developing scalable and secure payment solutions for <span class='text-secondary-2'>e-commerce platforms</span> tailored to your business needs.",
    },
    {
      id: 6,
      icon: (
  ...
  const ServiceCard = ({ service }: { service: ServiceItem }) => (
    <div className="col-lg-4 col-md-6">
      <div className="card-servies-2 rounded-2 h-100 hover-up">
        ...
        <p
          className="fs-7 text-300 fw-regular"
